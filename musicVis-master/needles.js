...
//	var maxAngle = TWO_PI - PI / 10;
	...
	this.onResize = function() {
        ...
        //makes ticks resize according to plotHeight
        this.dialHeight = this.plotHeight * 0.003;
	};
	...
	this.ticks = function(centreX, bottomY, freqLabel) {
		...
		for (var i = 0; i < 9; i++) {
			...
			var y = (this.dialRadius)*this.dialHeight * sin(nextTickAngle);
			var y1 = (this.dialRadius - 5)*this.dialHeight * sin(nextTickAngle);
